...
## Phase 3: 認証 & ユーザー別PDF管理（先行）

**AskPDF** をユーザーごとに安全に使えるようにするため、認証とPDF管理を先に実装します。
...
* **Upload/Display**: ユーザーごとにPDFをアップロード・一覧・表示できる状態にする。

---

## Phase 4: ハイライト・ストリーミング・最適化

PDF上の根拠表示やリアルタイム性の強化など、体験を深めるフェーズです。
...
| **Phase 3** | ユーザー別運用の開始 | 会員登録ができ、ユーザーごとにPDFをアップロード・表示できる |
| **Phase 4** | UIの完成 | **PDF上の正しい位置が光る** |
